...
namespace PbLabourStatic.Controllers
{
    ...
    {
        private readonly ILogger<PublicInterfaceController> _logger;
        private readonly IConfiguration _configuration;
        private readonly AppDbContext _context;
        public PublicInterfaceController(ILogger<PublicInterfaceController> logger, IConfiguration configuration, AppDbContext context)
        {
            _logger = logger;
            _configuration = configuration;
            _context = context;
        }
        public IActionResult ThirdPartyVerification()
        {
        ...
        public IActionResult FunctionsAndActivities()
        {
            ViewBag.pbLabourAdminStaticBaseUrl = _configuration.GetSection("AppPath").GetSection("pbLabourAdminStaticBaseUrl").Value;
            ViewBag.rootPath = _configuration.GetSection("AppPath").GetSection("rootPath").Value;
            return View();
